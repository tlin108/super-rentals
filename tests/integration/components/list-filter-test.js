...
test('should initially load all listings', function (assert) {
  // we want our action to return promises, since they are potentially fetching data asynchronously
  ...
  // the xhr requests to resolve before running the contents of the then block.
  return wait().then(() ==> {
